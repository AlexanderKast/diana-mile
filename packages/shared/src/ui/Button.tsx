  ...
  ({ variant = "primary", className, children, disabled, ...props }, ref) => {
    return (
      <button
        ...
        disabled={disabled}
        className={cx(
          "inline-flex items-center justify-center gap-2 rounded-lg px-6 py-3.5 min-h-[44px] text-base font-semibold tracking-wide transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100",
          variant === "primary" &&
