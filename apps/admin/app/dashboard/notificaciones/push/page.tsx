  ...
  return (
    <div>
      <Link
        ...
        className="text-sm text-morado hover:text-morado-oscuro transition-colors"
      >
        ← Alertas
      </Link>
      <h1 className="font-display text-2xl text-carbon mb-2 mt-3">
        Notificaciones push a clientas
      </h1>
